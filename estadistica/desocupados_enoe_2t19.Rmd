...
```{r bd_manuales, message=FALSE, warning= FALSE}

#importando los documentos necesarios
enoe_2T <- read_csv("/Users/danielapintoveizaga/Teoría Económica/Estadística/ENOE/2019trim2_csv/COE2T219.csv")
enoe_1T <- read_csv("/Users/danielapintoveizaga/Teoría Económica/Estadística/ENOE/2019trim2_csv/COE1T219.csv")
socio_demografico <- read_csv("/Users/danielapintoveizaga/Teoría Económica/Estadística/ENOE/2019trim2_csv/SDEMT219.csv")
...
ggplot(desocupados) + geom_bar(aes(desocupados$sex, y = ..prop.., group = 1, weight=fac)) +  ggtitle("Población Desocupada")  + labs(y="Proporción", x = "Sexo", fill="Sexo", caption="Fuente: ENOE, Segundo Trimestre 2019", subtitle = "Proporción Por Sexo")
